...
namespace Antorena_Soto.CLogica
{
    ...
    public class UsuarioBLL
    {
        ...
        public bool AgregarUsuario(string dni, string nombre, string provincia, string ciudad,
                                   string domicilio, string telefono, string correo, DateTime fechaNacimiento, long cuit
                                   , DateTime fechaIngreso)
        {
            ...
            return usuarioDAL.InsertarUsuario(dniInt, nombre, provincia, ciudad, domicilio, telefono, correo, fechaNacimiento, cuit, fechaIngreso);
        }
    }
}